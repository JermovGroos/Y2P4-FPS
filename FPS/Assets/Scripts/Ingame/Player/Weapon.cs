...
public class Weapon : Photon.MonoBehaviour
{
    ...
    public void CalculateStats(int index)
    {
        ...
        stats.AttachmentStatsChange(layout.weapons[data.currentWeapon].barrels[data.currentBarrel].addStats);
        stats.AttachmentStatsChange(layout.weapons[data.currentWeapon].magazines[data.currentMagazine].addStats);
    }
